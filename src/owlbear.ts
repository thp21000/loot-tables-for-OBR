...
const ACTION_POPOVER_WIDTH = 1150;
const ACTION_POPOVER_HEIGHT = 950;
const GAIN_MODAL_WIDTH = 760;
const GAIN_MODAL_HEIGHT = 640;
...
export async function openValidatedRollModal(
  ...
  try {
    ...
    await OBR.modal.open({
      ...
      url: modalUrl,
      width: GAIN_MODAL_WIDTH,
      height: GAIN_MODAL_HEIGHT,
    });
  } catch (error) {
